      ...
      <div className="container container-soft2">
        ...
        <div className="solution-wrapp">
          ...
          <div className="circle">
            ...
            >
              <path
                className="path svg-fadein one"
                d="M134.082 44.1647C129.483 46.441 123.958 45.5885 120.33 41.9589C114.571 36.1988 116.173 26.4863 123.471 22.8694C152.991 8.23772 186.218 0 221.336 0C256.453 0 289.68 8.23772 319.2 22.8683C326.497 26.4863 328.099 36.1988 322.34 41.9589C318.712 45.5874 313.188 46.441 308.588 44.1647C282.265 31.1349 252.641 23.8017 221.336 23.8017C190.03 23.8017 160.405 31.1349 134.082 44.1647Z"
                fill="#9558EC"
              >
                {/* <!-- <animate attributeName="fill" dur="1500ms" to="#9558EC" fill="freeze" id="two" begin="one.end"/> --> */}
              </path>
              <path
                className="path svg-fadein two"
                ...
                fill="#9558EC"
              >
                {/* <!-- <animate attributeName="fill" dur="1500ms" to="#9558EC" fill="freeze" id="three" begin="two.end"/> --> */}
              </path>
              <path
                className="path svg-fadein three"
                ...
                fill="#9558EC"
              >
                {/* <!-- <animate attributeName="fill" dur="1500ms" to="#9558EC" fill="freeze" id="four" begin="three.end"/> --> */}
              </path>
              <path
                className="path svg-fadein four"
                d="M44.1647 134.238C46.441 129.639 45.5885 124.114 41.9589 120.486C36.1988 114.727 26.4863 116.329 22.8694 123.627C8.23772 153.147 -3.03244e-06 186.374 -4.5675e-06 221.492C-6.10251e-06 256.609 8.23771 289.836 22.8683 319.356C26.4863 326.653 36.1988 328.255 41.9589 322.496C45.5874 318.868 46.441 313.344 44.1647 308.744C31.1349 282.421 23.8017 252.797 23.8017 221.492C23.8017 190.186 31.1349 160.561 44.1647 134.238Z"
                fill="#9558EC"
              >
                {/* <!-- <animate attributeName="fill" dur="1500ms" to="#9558EC" fill="freeze" id="one" begin="0s;"/> --> */}
              </path>
            </svg>
            <div className="icons">
              <div className="icon">
