...
import serviceIcon1Svg from "@/assets/images/home_8/icons/service-icon1.svg";
import serviceIcon2Svg from "@/assets/images/home_8/icons/service-icon2.svg";
import serviceIcon3Svg from "@/assets/images/home_8/icons/service-icon3.svg";
        ...
        <div className="row">
          <div className="col-lg-4 col-md-6">
            <div className="services-item wow fadeInLeft" data-wow-delay="0.2s">
              {/* Converted from <Image src={serviceIcon1Svg}> */}
              <Image src={serviceIcon1Svg} alt="" />
          ...
          <div className="col-lg-4 col-md-6 mt-sm-0 mt-5">
            <div className="services-item wow fadeInDown" data-wow-delay="0.2s">
              {/* Converted from <Image src={serviceIcon2Svg}> */}
              <Image src={serviceIcon2Svg} alt="" />
          ...
          <div className="col-lg-4 col-md-6 mt-lg-0 mt-5 mx-auto">
            <div
              ...
              data-wow-delay="0.2s"
            >
              {/* Converted from <Image src={serviceIcon3Svg}> */}
              <Image src={serviceIcon3Svg} alt="" />
