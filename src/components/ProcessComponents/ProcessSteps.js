...
import icon2Svg from "@/assets/images/process/icon2.svg";
import icon5Svg from "@/assets/images/process/icon5.svg";
import icon1Svg from "@/assets/images/process/icon1.svg";
import icon3Svg from "@/assets/images/process/icon3.svg";
import icon4Svg from "@/assets/images/process/icon4.svg";
            ...
            <div className="col-lg-6 col-md-9">
              <div className="process-item-content">
                ...
                <div className="content">
                  <h3 className="title">Language and Personality</h3>
                  <p className="text">
                ...
                <div className="meta">
                  <p className="percent">
                    <span className="counter">
                      <CountUp end={26} delay={1} duration={2.5} />.
                      <CountUp end={4} delay={1} duration={2.5} />%
                    </span>
                  </p>
                  <p className="label">of applicants pass</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-9">
              <div className="process-item-content">
                ...
                <div className="content">
                  <h3 className="title">In-Depth Skill Review</h3>
                  <p className="text">
            ...
            <div className="col-lg-5 offset-lg-1 col-md-3">
              <div className="process-item-progress">
                ...
                <div className="meta">
                  <p className="percent">
                    <span className="counter">
                      <CountUp end={7} delay={1} duration={2.5} />.
                      <CountUp end={4} delay={1} duration={2.5} />%
                    </span>
                  </p>
                  <p className="label">of applicants pass</p>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-9">
              <div className="process-item-content">
                ...
                <div className="content">
                  <h3 className="title">Live Screening</h3>
                  <p className="text">
            ...
            <div className="col-lg-5 offset-lg-1 col-md-3">
              <div className="process-item-progress">
                ...
                <div className="meta">
                  <p className="percent">
                    <span className="counter">3.6</span>%
                  </p>
                  <p className="label">of applicants pass</p>
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-9">
              <div className="process-item-content">
                ...
                <div className="content">
                  <h3 className="title">Test Projects</h3>
                  <p className="text">
            ...
            <div className="col-lg-5 offset-lg-1 col-md-3">
              <div className="process-item-progress">
                ...
                <div className="meta">
                  <p className="percent">
                    <span className="counter">
                      <CountUp end={0} delay={1} duration={2.5} />.
                      <CountUp end={6} delay={1} duration={2.5} />%
                    </span>
                  </p>
                  <p className="label">of applicants pass</p>
                </div>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-9">
              <div className="process-item-content">
                ...
                <div className="content">
                  <h3 className="title">Continued Excellence</h3>
                  <p className="text">
            ...
            <div className="col-lg-5 offset-lg-1 col-md-3">
              <div className="process-item-progress">
                ...
                <div className="meta">
                  <p className="percent">
                    <span className="counter">
                      <CountUp end={3} delay={1} duration={2.5} />.
                      <CountUp end={0} delay={1} duration={2.5} />%
                    </span>
                  </p>
                  <p className="label">of applicants pass</p>
