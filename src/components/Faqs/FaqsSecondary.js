...
export default function FaqsSecondary() {
  return (
    <section className="question-area pb-140">
      <div className="container">
        <div className="question_inner row">
              ...
              >
                <div className="ques_item wow fadeInUp" data-wow-delay="0.2s">
                  ...
                  <p>
                    ...
                    we don’t issue refunds on the cases Envato does not
                    guarantee refunds.
                  </p>
                </div>
                ...
                <div className="ques_item wow fadeInUp" data-wow-delay="0.6s">
                  ...
                  <p>
                    ...
                    Autem, proin quam tempora! Suscipit cupidatat vitae, vitae
                  </p>
                </div>
              </div>
              <div
